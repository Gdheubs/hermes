...
def _dispatch_once_locked(
    ...
    *,
    ...
    # Orphaned-card reconciliation (upstream): requeue 'running' cards whose
    # claim bookkeeping is broken (no valid claim, dead/gone worker) that the
    # TTL/crash/stale paths can never see. Complementary to the non-running
    # clear above; both are required.
