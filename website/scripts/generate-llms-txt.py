...
When GitHub Pages is enabled for this fork, both publish below:
  https://recursiveintell.github.io/hermes-agent/docs/llms.txt
  https://recursiveintell.github.io/hermes-agent/docs/llms-full.txt
