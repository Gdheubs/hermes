...
| [`on_turn_failed`](/user-guide/features/hooks#on_turn_failed) | Retry and fallback options are exhausted for a turn | `session_id: str, completed: bool, failed: bool, failure_reason: str, error: str, http_status: int \| None, provider: str, model: str, max_retries: int, api_calls: int` | ignored |
