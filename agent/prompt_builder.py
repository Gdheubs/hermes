...
KANBAN_GUIDANCE = (
    ...
    "task). It returns bounded latest slices of task/history data with explicit "
    "truncation and omitted counts, attachment metadata, and parent handoffs. "
    "Recovery handles remain exact; use `kanban_attachments` for all files or "
    "the dashboard/CLI for complete canonical history.\n"
