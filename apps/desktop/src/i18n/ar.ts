...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    viewMenu: {
      ...
      useView: 'استخدام طريقة العرض',
      apply: 'التبديل واستخدام طريقة العرض',
      saveCurrent: 'حفظ طريقة العرض الحالية…',
      updateCurrent: 'تحديث بالإعدادات الحالية',
      update: 'تحديث',
      rename: 'إعادة تسمية…',
      delete: 'حذف',
      saveTitle: 'حفظ طريقة عرض الشريط الجانبي',
      saveDescription: 'احفظ التجميع والترتيب وعوامل التصفية ونطاق الملف الشخصي والبيانات الوصفية ونمط العرض الحالي.',
      renameTitle: 'إعادة تسمية طريقة عرض الشريط الجانبي',
      renameDescription: 'اختر اسمًا جديدًا لطريقة العرض المحفوظة.',
      applyTitle: 'التبديل إلى الملف الشخصي واستخدام طريقة العرض؟',
      applyDescription: (name, profile) =>
        `ستنتقل طريقة العرض «${name}» إلى الملف الشخصي «${profile}» وتبدأ محادثة جديدة قبل تطبيقها.`,
      updateTitle: 'تحديث طريقة العرض المحفوظة؟',
      updateDescription: name => `هل تريد استبدال «${name}» بإعدادات الشريط الجانبي الحالية؟`,
      deleteTitle: 'حذف طريقة عرض الشريط الجانبي؟',
      deleteDescription: name => `هل تريد حذف «${name}»؟ لن يتغير الشريط الجانبي الحالي.`,
      nameLabel: 'الاسم',
      namePlaceholder: 'مثال: يحتاج إلى مراجعة',
      grouping: 'التجميع',
      ordering: 'الترتيب',
      show: 'إظهار',
