...
export const ar = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      restartCurrent: 'إعادة تشغيل الخلفية الحالية',
      restartCurrentTitle: 'إعادة تشغيل الخلفية الحالية',
      restartCurrentDesc: 'أعد تشغيل الخلفية المحلية أو SSH التي يديرها Desktop. قد تنقطع المهام النشطة.',
      restartingCurrent: 'جارٍ إعادة تشغيل الخلفية…',
      restartCurrentSuccess: 'أعيد تشغيل الخلفية وأعيد اتصال Desktop.',
      restartCurrentCancelled: 'أُلغيت إعادة التشغيل. الخلفية مستمرة.',
      restartCurrentRemote: 'الخلفية البعيدة لا يديرها Desktop. المتاح إعادة الاتصال فقط.',
      restartCurrentOwnershipFailed: 'توقفت الإعادة: تعذر على Desktop إثبات الملكية. لم تُنهَ أي عملية.',
      restartCurrentFailed: 'فشلت إعادة تشغيل الخلفية. يمكن استعادة الاتصال.',
