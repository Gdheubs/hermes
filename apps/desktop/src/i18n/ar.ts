...
export const ar = defineLocale({
  ...
  settings: {
    ...
    about: {
      ...
      support: 'الدعم',
      reportProblem: 'الإبلاغ عن مشكلة على GitHub',
      reportProblemDesc: 'افتح مسودة مشكلة قابلة للتعديل على GitHub مع تفاصيل سطح المكتب الأساسية. راجعها قبل الإرسال؛ لا يتم إرسال أي شيء تلقائياً.',
      reportProblemAction: 'الإبلاغ على GitHub',
      never: 'أبدا',
      justNow: 'الآن',
