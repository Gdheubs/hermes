...
/** Persistent recovery guidance for a backend that has paused state.db writes. */
      ...
      <div className="flex max-w-2xl items-start gap-2 rounded-md border border-destructive/45 bg-destructive/12 px-3 py-2 text-sm shadow-lg">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Historical chats are preserved but currently unavailable. Persistence is paused; stop profile writers, then run
